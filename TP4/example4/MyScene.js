...
class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        this.cubequad=new MyCubeQuad(this);
        ...
        this.texture3 = new CGFtexture(this, 'images/tangram.png');
        //-------
        ...
        this.show_my_quad=true;
        this.show_my_quad_material=true;
        this.show_my_tangram=false;
    ...
    display() {
        ...
        if(this.show_my_quad){
            
            if(this.show_my_quad_material){
                this.quadMaterial.apply();
            }
            
            this.quad.display();
        }else if(this.show_my_tangram==true){
